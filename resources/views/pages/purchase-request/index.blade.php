    ...
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <a href="{{route('purchase-request.create')}}" class="btn btn-primary waves-effect waves-light">
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline">
                            ...
                            <tbody>
                                @foreach ($pr as $item)
                                    <tr>
                                        <td>{{date_format(date_create($item->requested_at),"Y-m-d")}}</td>
                                        <td>
                                            <a href="{{route('purchase-request.show',$item->id)}}">{{$item->pr_no}}</a>
                                        </td>
